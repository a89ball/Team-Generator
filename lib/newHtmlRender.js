...
function engineerTemplate(name, id, email, role, github) {
    const manager = `<div class='container'>
    <div id='results'>
        <div class="card" style="width: 18rem;">
            <div class="card-header bg-primary">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">ID: ${id}</li>
                <li class="list-group-item">Email: <a href="mailto:${email}"></a></li>
                <li class="list-group-item">Github: <a href="${github}">}</li>
            </ul>
        </div>
    </div>
</div>`}
function internTemplate(name, id, email, role, school) {
    const manager = `<div class='container'>
    <div id='results'>
        <div class="card" style="width: 18rem;">
            <div class="card-header bg-primary">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">ID: ${id}</li>
                <li class="list-group-item">Email: <a href="mailto:${email}"></a></li>
                <li class="list-group-item">School: <a href="${school}">}</li>
            </ul>
        </div>
    </div>
</div>`
